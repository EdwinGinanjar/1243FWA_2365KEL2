...
<head>
	<meta charset="UTF-8">
	<title>@yield('page_title', 'Kelompok 2') | Framework</title>
...
<div class="clearfix"></div>
	...
	<nav class="navbar navbar-default navbar-fixed-bottom">
		...
		created by <a href="http://instagram.com/fannyaqmarina"><span><i class="fa fa-instagram" style="color:salmon"></i>@fannyaqmarina</span></a>	
		</footer>
	</nav>
