...
<div class="panel-heading">
	...
	<a href="{{url('tambah_rawat')}}" class="btn btn-xs btn-primary pull-right">
	...
	<a href="{{url('edit_rawat/edit/'.$pasien_dokter->id)}}" class="btn btn-info btn-xs" data-toogle="tooltip" data-placement="top" title="Edit">Edit</a>
	<a href  ="{{url('pasien_dokter/lihat/'.$pasien_dokter->id)}}" class="btn btn-warning btn-xs" data-toogle="tooltip" data-placement="top" title="lihat">Detail</a>
