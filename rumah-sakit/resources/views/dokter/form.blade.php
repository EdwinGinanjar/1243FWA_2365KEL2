...
<div class="col-sm-10">
	{!! Form::select('spesialis_id',$spesialis->listsj(),null,['class'=>'form-control','id'=>'spesialis_id','placeholder'=>"Spesialis"])!!}
</div>
</div>
...
<div class="form-group">
<div class="col-sm-10">
	{!! Form::hidden('level','1',['class'=>'form-control','placeholder'=>"password"])!!}
</div>
</div>